...
import { AudioFinalComponent, DialogAudioComponent, DialogPicComponent } from './audio-final.component';
...
@NgModule({
  declarations: [
    AudioFinalComponent, DialogAudioComponent,DialogPicComponent,
  ...
  entryComponents: [
    DialogAudioComponent,DialogPicComponent,
    DialogAfterAudio,
    DialogAfterOldAudio,
